...
- Port 3456 open on your router (forward to 192.168.1.200:3456)
...
4. **Verify it works**
   ...
   - Visit: `http://192.168.1.200:3456/api/health`
...
5. **Port forwarding for remote access**
   - In your router admin panel, add a port forward rule:
     - External port: 3456 → Internal IP: 192.168.1.200 → Internal port: 3456
   - Test from outside: `http://pansketo.arcdns.tech:3456/api/health`
...
3. Enter:
   - **NAS URL:** `http://pansketo.arcdns.tech:3456`  
     *(or `http://192.168.1.200:3456` when on home Wi-Fi)*
...
- Try the local IP first: `http://192.168.1.200:3456/api/health`
